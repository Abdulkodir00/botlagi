...
await conn.sendButton(m.chat, cap, '© 𝘾𝙧𝙚𝙖𝙩𝙚𝙙 𝘽𝙮 𝘼𝙠𝙞𝙤 𝘽𝙤𝙩 𝙈𝙙', Buffer.alloc(0), [['List Menu', '.tesm'], ['All Menu', '/allmenu']], fkontak, { mimetype: "text/rtf", fileName: '𝑺𝒊𝒎𝒑𝒍𝒆 𝑩𝒐𝒕 𝑾𝒉𝒂𝒕𝒔𝑨𝒑𝒑 𝑩𝒚 𝘿𝙞𝙠𝙞', pageCount: 90000, fileLength: 90000, seconds: 90000, jpegThumbnail: pepe, contextInfo: {
          externalAdReply :{
          showAdAttribution: true,
    mediaUrl: sig,
    mediaType: 2,
    description: "WATERMAR", 
    title: "𝐀𝐤𝐢𝐨 𝐁𝐨𝐭 𝐕 𝟏.𝟎.𝟐",
